                    ...
                    [      
                        ...
                        HumanMessage(
                                content=f"""
                                    ...
                                    Під час декомпозиції запиту відрізняй основне дослідницьке твердження
                                    від контекстних фактів, дат і формулювань.

                                    Не створюй окремий крок для перевірки контекстного факту, якщо його
                                    підтвердження або спростування не є необхідним для відповіді на
                                    основне дослідницьке питання.

                                    Спочатку визнач, яке саме твердження користувач просить перевірити,
                                    і плануй лише ті дослідницькі кроки, які необхідні для його оцінки.
